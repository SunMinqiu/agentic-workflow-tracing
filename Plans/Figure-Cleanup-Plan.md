...
ssh -t "$SSH_USER@$CLIENT_NODE" \
  "cd pi-ebpf-tracing-handoff && sudo -n true && RUN_WORKLOADS='eels_plasmons_basic,eels_identification_basic,polycrystalline_grains_basic,planning_critical_materials' bash scripts/trace_script_bcc_scilink.sh"
